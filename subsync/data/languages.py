...
languages = [
        ...
        mkLanguage( 'por', 'pt', _('Portuguese'), ['UTF-8', 'Windows-1252', 'ISO-8859-1'], extraCodes=[ 'pt-pt' ]),
        mkLanguage( 'pob', None, _('Portuguese (Brazil)'), ['UTF-8', 'Windows-1252', 'ISO-8859-1'], extraCodes=[ 'pt-br', 'pt_BR', 'ptbr', 'pb' ]),
